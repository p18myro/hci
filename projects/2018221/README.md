...
## Επιπλέον δύο Εργασίες γραμμής εντολών αντι εξεταστικής Σεπτεμβρίου
...
* [x] Κάνω search
* [x] Άνοιξα το Fzf χωρίς να είναι full screen με χρήση την εντολής (fzf --height 40%), χρήση της εντολής για να κάνω kill command (kill -9 <TAB>)
